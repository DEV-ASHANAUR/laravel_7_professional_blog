...
<div class="py-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <span>Tag</span>
                <h3 style="text-transform: capitalize;">{{ $tag->name }}</h3>
                <p>@if ($tag->description)
                    {{ $tag->description }}
                @endif</p>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12 mb-4">
                <h3 class="text-center" style="text-transform: capitalize;">There is No Post in This Tag! </h3>
            </div>    
            @endif
            {{-- <div class="col-lg-4 mb-4">
                <div class="entry2">
