        ...
        <div class="container">
            <div class="row mb-5 justify-content-center">
                <div class="col-md-5 text-center">
                    <h2>Meet The Team</h2>
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Delectus commodi blanditiis,
                        soluta magnam atque laborum ex qui recusandae</p>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-md-6 col-lg-4 mb-5 text-center">
                    <img src="{{ asset('website') }}/images/person_3.jpg" alt="Image"
                        class="img-fluid w-50 rounded-circle mb-4">
